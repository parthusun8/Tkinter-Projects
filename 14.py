...
title = Label(root, text="Welcome to Real Time Currency Converter", width=40, justify=CENTER)
title.config(background="light blue", pady=2, padx=2)
title.grid(row=0, column=0, columnspan=2)

money = Label(root, text="1 USD = 74.93 Indian Rupee\nDate:2022-04-22", font=("bold", 13))
...
button = Button(root, text="Convert", fg="white", bg="Blue", command=convert)
