...
gender = Label(tk, text="Source")
gender.grid(column=0, row=3)
male = Radiobutton(tk, text="Delhi", variable=g, command=setVal, value=1)
female = Radiobutton(tk, text="Mumbai", variable=g, command=setVal, value=2)
male.grid(column=1, row=3)
female.grid(column=2, row=3)

d = IntVar()
gender = Label(tk, text="Destination")
gender.grid(column=3, row=3)
male = Radiobutton(tk, text="Chennai", variable=d, command=setDes, value=1)
female = Radiobutton(tk, text="Kolkata", variable=d, command=setDes, value=2)
male.grid(column=4, row=3)
female.grid(column=5, row=3)

age = Label(tk, text="Age")
age.grid(column=0, row=4)
ageEn = Spinbox(tk, from_=15, to=25)
